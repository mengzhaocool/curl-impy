...
3. Apply patches from patches_new/ directory
...
WIN_BUILD_DIR = ROOT_DIR / "win_build"
PATCHES_DIR = ROOT_DIR / "patches_new"
...
def apply_all_patches(deps_dir, git_exe):
    """Apply patches from patches_new/ to all deps. Exits on failure."""
    # BoringSSL patch
...
def main():
    ...
    if not PATCHES_DIR.exists():
        log(f"patches_new/ directory not found at {PATCHES_DIR}", "ERROR")
